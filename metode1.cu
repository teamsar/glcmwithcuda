...
void printMatrixGlcm(int *C, const int Max,int degree,int gambar)
{
    ...
    if(gambar==128){
        if(degree==0){
            fp = fopen("./data/GLCM/Sample128/Sudut_0/matrix_glcm_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/GLCM/Sample128/Sudut_90/matrix_glcm_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/GLCM/Sample128/Sudut_180/matrix_glcm_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/GLCM/Sample128/Sudut_270/matrix_glcm_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/GLCM/Sample128/Sudut_45/matrix_glcm_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/GLCM/Sample128/Sudut_135/matrix_glcm_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/GLCM/Sample128/Sudut_225/matrix_glcm_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/GLCM/Sample128/Sudut_315/matrix_glcm_315_method1.txt", "w+");
        }
    }
    else if(gambar==256){
        if(degree==0){
            fp = fopen("./data/GLCM/Sample256/Sudut_0/matrix_glcm_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/GLCM/Sample256/Sudut_90/matrix_glcm_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/GLCM/Sample256/Sudut_180/matrix_glcm_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/GLCM/Sample256/Sudut_270/matrix_glcm_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/GLCM/Sample256/Sudut_45/matrix_glcm_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/GLCM/Sample256/Sudut_135/matrix_glcm_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/GLCM/Sample256/Sudut_225/matrix_glcm_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/GLCM/Sample256/Sudut_315/matrix_glcm_315_method1.txt", "w+");
        }
    }
    else if(gambar==512){
        if(degree==0){
            fp = fopen("./data/GLCM/Sample512/Sudut_0/matrix_glcm_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/GLCM/Sample512/Sudut_90/matrix_glcm_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/GLCM/Sample512/Sudut_180/matrix_glcm_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/GLCM/Sample512/Sudut_270/matrix_glcm_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/GLCM/Sample512/Sudut_45/matrix_glcm_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/GLCM/Sample512/Sudut_135/matrix_glcm_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/GLCM/Sample512/Sudut_225/matrix_glcm_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/GLCM/Sample512/Sudut_315/matrix_glcm_315_method1.txt", "w+");
        }
    }
    else if(gambar==1024){
        if(degree==0){
            fp = fopen("./data/GLCM/Sample1024/Sudut_0/matrix_glcm_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/GLCM/Sample1024/Sudut_90/matrix_glcm_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/GLCM/Sample1024/Sudut_180/matrix_glcm_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/GLCM/Sample1024/Sudut_270/matrix_glcm_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/GLCM/Sample1024/Sudut_45/matrix_glcm_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/GLCM/Sample1024/Sudut_135/matrix_glcm_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/GLCM/Sample1024/Sudut_225/matrix_glcm_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/GLCM/Sample1024/Sudut_315/matrix_glcm_315_method1.txt", "w+");
        }
    }
...
void printMatrixnxormalization(float *C, const int Max,int degree,int gambar)
{
    ...
    if(gambar==128){
        if(degree==0){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_0/matrix_normalisasi_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_90/matrix_normalisasi_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_180/matrix_normalisasi_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_270/matrix_normalisasi_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_45/matrix_normalisasi_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_135/matrix_normalisasi_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_225/matrix_normalisasi_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/Normalisasi/Sample128/Sudut_315/matrix_normalisasi_315_method1.txt", "w+");
        }
    }
    else if(gambar==256){
        if(degree==0){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_0/matrix_normalisasi_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_90/matrix_normalisasi_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_180/matrix_normalisasi_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_270/matrix_normalisasi_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_45/matrix_normalisasi_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_135/matrix_normalisasi_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_225/matrix_normalisasi_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/Normalisasi/Sample256/Sudut_315/matrix_normalisasi_315_method1.txt", "w+");
        }
    }
    else if(gambar==512){
        if(degree==0){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_0/matrix_normalisasi_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_90/matrix_normalisasi_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_180/matrix_normalisasi_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_270/matrix_normalisasi_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_45/matrix_normalisasi_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_135/matrix_normalisasi_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_225/matrix_normalisasi_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/Normalisasi/Sample512/Sudut_315/matrix_normalisasi_315_method1.txt", "w+");
        }
    }
    else if(gambar==1024){
        if(degree==0){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_0/matrix_normalisasi_0_method1.txt", "w+");
        }
        else if(degree==90){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_90/matrix_normalisasi_90_method1.txt", "w+");
        }
        else if(degree==180){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_180/matrix_normalisasi_180_method1.txt", "w+");
        }
        else if(degree==270){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_270/matrix_normalisasi_270_method1.txt", "w+");
        }
        else if(degree==45){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_45/matrix_normalisasi_45_method1.txt", "w+");
        }
        else if(degree==135){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_135/matrix_normalisasi_135_method1.txt", "w+");
        }
        else if(degree==225){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_225/matrix_normalisasi_225_method1.txt", "w+");
        }
        else if(degree==315){
            fp = fopen("./data/Normalisasi/Sample1024/Sudut_315/matrix_normalisasi_315_method1.txt", "w+");
        }
    }
    if(fp == NULL){
        printf("Error creating results file\n");
...
int main(int argc, char *argv[]){
    ...
    printf("matrix gambar disimpan di matrixgambarmetode1.txt\n");
    printf("matrix glcm disimpan di matrix_glcm_%d.txt\n",degree);
    printf("matrix glcm normalisasi disimpan di matrix_ormalisasi_%d_update.txt\n",degree);
